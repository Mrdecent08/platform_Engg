...
public class UbiqController {
	...
	@PostMapping("/encrypt")
	public String encrypt(@RequestBody String data) throws IOException, IllegalStateException, InvalidCipherTextException{
	...
	@PostMapping("/decrypt")
	public String decrypt(@RequestBody String data) throws IllegalStateException, InvalidCipherTextException, IOException {
